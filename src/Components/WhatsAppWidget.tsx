  ...
  return (
    <div className={styles.container} ref={ref}>
      ...
      >
        ...
        <span className={styles.label}>{phoneDisplay}</span>
      </button>

      <div className={`${styles.menu} ${open ? styles.open : ""}`} role="menu" aria-hidden={!open}>
        <a className={styles.item} href={whatsappHref} target="_blank" rel="noopener noreferrer" role="menuitem">
          <strong>WhatsApp</strong>
          <span className={styles.sm}>Chat</span>
        </a>
        <a className={styles.item} href={telegramHref} target="_blank" rel="noopener noreferrer" role="menuitem">
          <strong>Telegram</strong>
          <span className={styles.sm}>Message</span>
        </a>
        ...
        <a className={styles.item} href={telHref} role="menuitem">
          <strong>Call</strong>
          <span className={styles.sm}>{phoneDisplay}</span>
        </a>
      </div>
    </div>
  );
